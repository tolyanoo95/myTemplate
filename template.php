...
/*
{"settings":{"toolbar_1":"formatselect,bold,italic,blockquote,bullist,numlist,alignleft,aligncenter,alignright,link,unlink,undo,redo","toolbar_2":"fontselect,fontsizeselect,outdent,indent,pastetext,removeformat,visualchars,charmap,wp_more,forecolor,table,wp_help","toolbar_3":"underline,strikethrough,copy,paste,hr,print,searchreplace,anchor,visualblocks,fullscreen,nonbreaking,rtl,ltr,emoticons,wp_page,tadv_mark","toolbar_4":"alignjustify,styleselect,cut,superscript,subscript,image,wp_code,media,code,insertdatetime,backcolor","toolbar_classic_block":"formatselect,bold,italic,alignleft,alignjustify,aligncenter,alignright,nonbreaking,underline,strikethrough,outdent,indent,wp_more,blockquote,undo,removeformat,visualchars,bullist,hr,cut,copy,numlist,rtl,ltr,tadv_mark,wp_page,link,forecolor,visualblocks,fontselect,wp_code,code,searchreplace,fontsizeselect,styleselect,backcolor,anchor,table,subscript,charmap,wp_help,insertdatetime,emoticons,paste,pastetext,image,unlink,fullscreen,media,redo,superscript,print","toolbar_block":"core\/bold,core\/italic,core\/link,tadv\/removeformat","toolbar_block_side":[],"panels_block":"","options":"menubar,advlist","plugins":"anchor,visualchars,visualblocks,nonbreaking,emoticons,insertdatetime,table,print,searchreplace,code,advlist"},"admin_settings":{"options":"no_autop","disabled_editors":""}}
*/
